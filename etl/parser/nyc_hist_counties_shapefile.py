...
from feature_type_maps.nyc_historical_counties_types import default_types, use_types_map, use_sub_types_map
...
def extract_shapefile(shapefile, uri_name, simplify_tolerance=None):
    ...
    for feature in collection(shapefile, "r"):
        ...
        feature_code = default_types["default"] #default code (building)

...
# for the DONE file
#
#FID,user_id,layer_id,created_at,updated_at,comment,name,number,street,materials,use_type,use_subtype,geom,layer_year
columns = {
    "perris": ["FID","user_id", "layer_id", "created_at", "updated_at", "comment", "name", "number", "street", "materials", "use_type", "use_subtype", "geom", "layer_year" ]
           }
